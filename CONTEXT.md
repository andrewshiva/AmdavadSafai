...
- Map (`MapView.jsx` + `GET /api/wards/geojson`): ward polygons are **synthetic approximations** (see ADR-0001); cleanliness score `100 − penalty(minor 3 / moderate 6 / severe 10 / critical 15 / resolved 0.5)` → grade `A+..D`.
